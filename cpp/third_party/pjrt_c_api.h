...
// Vendored from openxla/xla (xla/pjrt/c/pjrt_c_api.h), Apache-2.0; see
// NOTICE. Unmodified. Used as a fallback when no XLA checkout provides the
// real header (see cpp/pjrt/api.h and CMakeLists.txt).
