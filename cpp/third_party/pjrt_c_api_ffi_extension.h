...
// Vendored from openxla/xla (xla/pjrt/c/pjrt_c_api_ffi_extension.h),
// Apache-2.0; see NOTICE. Only the pjrt_c_api.h include was adjusted so the
// header resolves through this project's include logic.
